...
namespace Sitecore.Support.ContentTesting.Pipelines.CancelTest
{
    using Data;
    using Data.Items;
    using Diagnostics;
    using Sitecore.ContentTesting.Pipelines.CancelTest;

    public class UnprotectTestedItems : CancelTestProcessor
    {
        public override void Process(CancelTestArgs args)
        {
